    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse"
        >
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-80 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 z-40 animate-scale-in">
          ...
          <div className="flex items-center space-x-3 p-4 border-b border-gray-200/50 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-t-2xl">
            <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center animate-bounce">
            ...
            <Sparkles className="w-4 h-4 text-yellow-500 animate-spin ml-auto" />
          </div>
          ...
          <div className="p-4 max-h-60 overflow-y-auto space-y-3">
            {messages.map((message, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-blue-50 to-purple-50 p-3 rounded-lg border-l-4 border-blue-400 animate-fade-in"
              >
